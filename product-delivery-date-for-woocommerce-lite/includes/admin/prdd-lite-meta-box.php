...
class prdd_lite_meta_box_class { 
    ...
    public static function prdd_lite_box() {
        add_meta_box( 'woocommerce-prdd-lite', 
    ...
    function prdd_lite_process_box( $post_id, $post ) {
        ...
        if ( isset( $_POST[ 'prdd_lite_delivery_field_mandatory' ] ) ) {
            $prdd_lite_delivery_field_mandatory = sanitize_text_field( $_POST[ 'prdd_lite_delivery_field_mandatory' ] );
        }

        if ( isset( $_POST[ 'prdd_lite_product_holiday' ] ) ) {
            $prdd_lite_holidays = sanitize_text_field( $_POST[ 'prdd_lite_product_holiday' ] );
        }
