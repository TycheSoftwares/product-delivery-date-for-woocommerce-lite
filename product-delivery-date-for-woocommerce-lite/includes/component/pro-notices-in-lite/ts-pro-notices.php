...
class Prdd_Lite_ts_pro_notices {
	...
	*/
	...
	public function __construct( $ts_plugin_name = '', $ts_plugin_prefix = '', $ts_pro_plugin_prefix = '', $ts_notices = array(), $ts_file = '', $ts_pro_file = '' ) {
		...
		//Add pro notices
        add_action( 'admin_notices', array( 'Prdd_Lite_ts_pro_notices', 'ts_notices_of_pro' ) );
		add_action( 'admin_init', array( 'Prdd_Lite_ts_pro_notices', 'ts_ignore_pro_notices' ) );
		
		add_action( self::$plugin_prefix . '_activate', array( 'Prdd_Lite_ts_pro_notices', 'ts_activate_time' ) );
	}
