    ...
    class woocommerce_prdd_lite {
        ...
        */
        function prdd_lite_after_add_to_cart() {
            ...
            if( isset( $prdd_settings ) && $prdd_settings == "on" ) {
                print ( '<table>
                    <tr><td><label class="delivery_date_label">' . __( "Delivery Date", "woocommerce-prdd-lite" ) . ': </label></td>
			    <td><input type="text" id="delivery_calender_lite" name="delivery_calender_lite" class="delivery_calender_lite" style="cursor: text!important;margin-bottom:10px;" readonly/></td>
                <td><img src="' . plugins_url() . '/product-delivery-date-for-woocommerce-lite/images/cal.png" width="20" height="20" style="cursor:pointer!important;" id ="delivery_cal_lite"/></td></tr></table>
