...
include_once( 'includes/admin/prdd-lite-meta-box.php' );
include_once( 'includes/prdd-lite-common.php' );
include_once( 'includes/prdd-lite-config.php' );
include_once( 'includes/admin/prdd-lite-delivery-charges.php' );
include_once( 'includes/admin/prdd-lite-estimate-delivery.php' );
include_once( 'includes/admin/prdd-lite-delivery-settings.php' );
include_once( 'includes/admin/prdd-lite-global-menu.php' );
include_once( 'includes/prdd-lite-process.php' );
include_once( 'includes/prdd-lite-validation.php' );

global $PrddLiteUpdateChecker;
$PrddLiteUpdateChecker = '1.10';
...
if ( !class_exists( 'woocommerce_prdd_lite' ) ) {
    ...
    class woocommerce_prdd_lite {
         ...
         * @since 2.0
         */
        function prdd_lite_my_enqueue_scripts_css() {
            $plugin_version_number = get_option( 'woocommerce_prdd_lite_db_version' );

            if ( get_post_type() == 'product' || ( isset( $_GET[ 'page' ] ) && $_GET[ 'page' ] == 'woocommerce_prdd_lite_page' && isset( $_GET[ 'action' ] ) && $_GET[ 'action' ] == 'bulk_product_settings' ) ) {
            ...
            if( isset( $_GET[ 'page' ] ) && $_GET[ 'page' ] == 'woocommerce_prdd_lite_page' ) {
         ...
         * @since 2.0
         */
        function prdd_lite_my_enqueue_scripts_js() {
            $plugin_version_number = get_option( 'woocommerce_prdd_lite_db_version' );
