...
if ( !class_exists( 'woocommerce_prdd_lite' ) ) {
    ...
    class woocommerce_prdd_lite {
        ...
        function prdd_lite_after_add_to_cart() {
            ...
            if( isset( $prdd_settings ) && $prdd_settings == "on" ) {
                print ( '<div id= "prdd_start_date" style = "position: relative; width: 50%; margin-top: 20px; "><label class="delivery_date_label" style = "margin-top:1em;">' . __( "Delivery Date", "woocommerce-prdd-lite" ) . ': </label>
                <input type="text" id="delivery_calender_lite" name="delivery_calender_lite" class="delivery_calender_lite" style="cursor: text!important; display : block; width:100% !important; box-sizing: border-box;" readonly/>
                <img src="' . plugins_url() . '/product-delivery-date-for-woocommerce-lite/images/cal.png" width="20" height="20" style="cursor:pointer!important; position: absolute; right: 5%; top: 63%;" id ="delivery_cal_lite" /></div>
